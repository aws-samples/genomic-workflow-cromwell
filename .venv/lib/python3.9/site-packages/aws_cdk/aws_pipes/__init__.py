    ...
    class PipeSourceParametersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param active_mq_broker_parameters: 
            :param dynamo_db_stream_parameters: 
            :param filter_criteria: 
            :param kinesis_stream_parameters: 
            :param managed_streaming_kafka_parameters: 
            :param rabbit_mq_broker_parameters: 
            :param self_managed_kafka_parameters: 
            :param sqs_queue_parameters: 
    ...
    class PipeSourceSelfManagedKafkaParametersProperty:
        def __init__(
            ...
            *,
            ...
            :param credentials: 
            :param maximum_batching_window_in_seconds: 
            :param server_root_ca_certificate: Optional SecretManager ARN which stores the database credentials.
            :param starting_position: 
            :param vpc: 
    ...
    class PipeTargetBatchJobParametersProperty:
        def __init__(
            ...
            *,
            ...
            :param array_properties: 
            :param container_overrides: 
    ...
    class PipeTargetParametersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param batch_job_parameters: 
            :param cloud_watch_logs_parameters: 
            :param ecs_task_parameters: 
            :param event_bridge_event_bus_parameters: 
            :param http_parameters: 
            ...
            :param kinesis_stream_parameters: 
            :param lambda_function_parameters: 
            :param redshift_data_parameters: 
            :param sage_maker_pipeline_parameters: 
            :param sqs_queue_parameters: 
            :param step_function_state_machine_parameters: 
