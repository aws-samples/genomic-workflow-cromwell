...
class CfnIdentitySource(
    ...
    def __init__(
        ...
        *,
        ...
        :param configuration: Contains configuration information used when creating a new . .. epigraph:: At this time, the only valid member of this structure is a user pool configuration. You must specify a ``userPoolArn`` , and optionally, a ``ClientId`` . This data type is used as a request parameter for the `CreateIdentitySource <https://docs.aws.amazon.com/API_CreateIdentitySource.html>`_ operation.
        :param policy_store_id: Specifies the ID of the in which you want to store this . Only policies and requests made using this can reference identities from the identity provider configured in the new .
        :param principal_entity_type: Specifies the namespace and data type of the principals generated for identities authenticated by the new .
        '''
        if __debug__:
    ...
    class CognitoUserPoolConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param client_ids: The unique application client IDs that are associated with the specified user pool. Example: ``"ClientIds": ["&ExampleCogClientId;"]``
    ...
    class IdentitySourceDetailsProperty:
        def __init__(
            ...
            *,
            ...
            :param open_id_issuer: A string that identifies the type of OIDC service represented by this . At this time, the only valid value is ``cognito`` .
...
class CfnIdentitySourceProps:
    ...
    def configuration(
        ...
        This data type is used as a request parameter for the `CreateIdentitySource <https://docs.aws.amazon.com/API_CreateIdentitySource.html>`_ operation.
...
class CfnPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param policy_store_id: Specifies the ``PolicyStoreId`` of the you want to store the policy in.
        '''
        if __debug__:
    ...
    class PolicyDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            :param static: A structure that describes . An doesn't use a template or allow placeholders for entities.
        ...
        def template_linked(
            ...
            The template can specify placeholders for ``principal`` and ``resource`` . When you use `CreatePolicy <https://docs.aws.amazon.com/API_CreatePolicy.html>`_ to create a policy from a template, you specify the exact principal and resource to use for the instantiated policy.
    ...
    class StaticPolicyDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            :param statement: The policy content of the , written in the .
    ...
    class TemplateLinkedPolicyDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            :param principal: The principal associated with this . substitutes this principal for the ``?principal`` placeholder in the when it evaluates an authorization request.
            :param resource: The resource associated with this . substitutes this resource for the ``?resource`` placeholder in the when it evaluates an authorization request.
...
class CfnPolicyStore(
    ...
    class SchemaDefinitionProperty:
        def __init__(self, *, cedar_json: typing.Optional[builtins.str] = None) -> None:
            ...
            :param cedar_json: A JSON string representation of the schema supported by applications that use this . For more information, see `Policy store schema <https://docs.aws.amazon.com/schema.html>`_ in the ** .
        ...
        def cedar_json(self) -> typing.Optional[builtins.str]:
            ...
            For more information, see `Policy store schema <https://docs.aws.amazon.com/schema.html>`_ in the ** .
...
class CfnPolicyTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param statement: Specifies the content that you want to use for the new , written in the policy language.
