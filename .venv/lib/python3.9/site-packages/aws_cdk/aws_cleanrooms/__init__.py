    ...
    class MemberSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            :param account_id: The identifier used to reference members of the collaboration. Currently only supports ID.
    ...
    class AnalysisRuleCustomProperty:
        def __init__(
            ...
            *,
            ...
            :param allowed_analysis_providers: The accounts that are allowed to query by the custom analysis rule. Required when ``allowedAnalyses`` is ``ANY_QUERY`` .
    ...
    class MembershipProtectedQueryResultConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param role_arn: The unique ARN for an IAM role that is used by to write protected query results to the result location, given by the member who can receive results.
